...
class ApplicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Application" do
    ...
    fill_in "Intention", with: @application.intention
    fill_in "Product", with: @application.product_id
    fill_in "Quantity", with: @application.quantity
    fill_in "Timestamp", with: @application.timestamp
